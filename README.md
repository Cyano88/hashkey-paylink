...
Programmable USDC payment infrastructure for hosted checkout, Telegram workflows, PolyDesk, Pocket, retail POS, Arc agreements, and agent commerce.
...
| Telegram dashboard | Create requests, open PolyDesk, and manage agents from chat | `/telegram/payment-links` |
...
- **Arc Agreements API:** Fixed, progressive, and milestone agreement infrastructure used by the standalone HashPayStream product.
...
| Arc Network | Agreement escrow, lifecycle reconciliation, and agentic payment testing |
...
| Arc agreement receipts | Confirmed agreement outcomes follow the same durable proof pattern |
