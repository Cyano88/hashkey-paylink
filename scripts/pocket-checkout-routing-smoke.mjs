...
assert.equal(selectPocketCheckoutRoute({ destination: 'base', amountUnits: usdc(6), balances: balances(1, 2, 8) }).kind, 'insufficient')
...
// Solana remains eligible for a direct Solana payment, but it must not become
// an automatic bridge source until the CCTP transaction is gas-sponsored.
