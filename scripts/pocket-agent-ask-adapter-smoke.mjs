...
const helperPanelSource = await readFile(new URL('../src/components/AgentHashPanel.tsx', import.meta.url), 'utf8')
...
assert.match(assistantPageSource, /components\/AgentHashPanel/)
assert.doesNotMatch(assistantPageSource, /pages\/TelegramPaymentLinks/)
assert.match(assistantPageSource, /PocketAgentHashPanel/)
