...
assert.match(panelSource, /crypto\.subtle\.digest\('SHA-256'/)
assert.match(panelSource, /Approve cancellation/)
assert.match(panelSource, /Request review/)
assert.doesNotMatch(panelSource, /0x… evidence hash/)
