...
try{
 ...
 console.log('PASS: shared stock Send review, duplicate lock, no premature Processing during approval, processing on submission, no historical success banner. No wallet or network calls.');
