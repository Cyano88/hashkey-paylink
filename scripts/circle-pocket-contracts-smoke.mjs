...
assert.match(pocketRouteShellSource, /await refreshPocketData/)
...
assert.match(pocketBankWithdrawControllerSource, /if \(next\.handoffVerified\)/)
...
assert.match(paymentReceiptSuccessSource, /Paycrest received your USDC/)
assert.match(paymentReceiptSuccessSource, /payment window elapsed before the deposit was detected/)
