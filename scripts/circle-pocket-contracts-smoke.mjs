...
assert.match(pocketSessionSplashSource, /navigation\?\.(?:type|type === 'reload')|navigation\?\.type === 'reload'/)
assert.match(pocketSessionSplashSource, /prefers-reduced-motion: reduce/)
assert.match(pocketSessionSplashSource, /setState\('holding'\), 60/)
assert.match(pocketSessionSplashSource, /setState\('launching'\), 760/)
assert.match(pocketSessionSplashSource, /setState\('idle'\), 820/)
...
assert.match(circlePocketAppSource, /usePocketSessionSplash\(landing\)/)
assert.match(circlePocketAppSource, /if \(landing\) return <PocketPageBoundary active="home"><PocketLandingPage splashState=\{splashState\} \/><\/PocketPageBoundary>/)
