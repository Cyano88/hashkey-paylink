...
assert.match(pocketSecureWalletSessionSource, /Pocket could not refresh the secure wallet session/)
...
assert.match(circlePocketAppBootSource, /if \(durableSession \|\| legacySession\)/)
