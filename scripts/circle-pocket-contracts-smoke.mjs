...
assert.match(pocketX402ControllerSource, /Pull down to update the balance\./)
...
assert.match(paymentPageSource, /Redirecting in 6 seconds/)
assert.doesNotMatch(paymentPageSource, /Funds detected\. Verifying transaction/)
