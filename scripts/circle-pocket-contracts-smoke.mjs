...
assert.match(pocketLandingSource, /duration-700 ease-\[cubic-bezier\(0\.16,1,0\.3,1\)\]/)
...
assert.match(pocketSessionSplashSource, /setState\('launching'\), 400/)
assert.match(pocketSessionSplashSource, /setState\('idle'\), 720/)
