...
assert.match(pocketMoveBankPageSource, /Fund with Bank/)
assert.match(pocketMoveBankPageSource, /Add Base USDC from a Nigerian bank\./)
assert.match(pocketMoveBankPageSource, /Slide to get bank details/)
