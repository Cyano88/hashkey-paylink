...
assert.match(pocketSlideActionSource, /const visualStatus = status === 'idle' && optimisticPending \? 'pending' : status/)
...
assert.match(pocketSlideActionSource, /Sent - confirming/)
