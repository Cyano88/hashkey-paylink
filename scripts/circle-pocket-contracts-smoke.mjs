...
assert.match(pocketWithdrawalControllerSource, /Transfer submitted\. Pocket is checking final delivery\./)
...
assert.match(pocketSessionSplashSource, /state !== 'holding' \|\| !canLaunch/)
...
assert.match(circlePocketAppBootSource, /unlockPocketBaseWallet\(\{ authenticated, email, getAccessToken \}\)/)
assert.match(circlePocketAppBootSource, /readPocketPaymentSecurity\(getAccessToken\)/)
assert.match(circlePocketAppBootSource, /if \(security\.configured\)/)
assert.match(circlePocketAppBootSource, /pocketSecureWalletSessionAvailable\(email\)/)
assert.match(circlePocketAppBootSource, /pocketQuickApprovalCredentialSaved\(email\)/)
assert.match(circlePocketAppBootSource, /if \(durableSession\)/)
assert.match(circlePocketAppBootSource, /restorePocketWalletSession\(email\)/)
assert.match(circlePocketAppBootSource, /const restored = await restorePocketWalletSession\(email\)\.catch\(\(\) => null\)/)
assert.ok(circlePocketAppBootSource.indexOf('readPocketPaymentSecurity(getAccessToken)') < circlePocketAppBootSource.indexOf('unlockPocketBaseWallet({ authenticated, email, getAccessToken })'))
assert.match(circlePocketAppBootSource, /PocketWalletAccessScreen/)
assert.match(circlePocketAppBootSource, /shouldOfferPocketQuickApproval\(\)/)
