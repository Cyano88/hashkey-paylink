...
assert.match(pocketWalletControllerSource, /sharedEvmSessions\.get\(key\)/)
assert.match(pocketWalletControllerSource, /if \(!pocketQuickApprovalEnabled\(\) && options\.allowSharedSession\)/)
...
assert.match(pocketWalletControllerSource, /sharedEvmSessions\.set\(evmSessionKey\(email, 'base', wallet\.address\), session\)/)
assert.match(pocketWalletControllerSource, /offerPocketQuickApprovalAfterEmail\(email, session\)/)
...
assert.match(pocketQuickApprovalSource, /NativeBiometric\.verifyIdentity/)
...
assert.match(pocketQuickApprovalSource, /negativeButtonText: 'Cancel payment'/)
assert.doesNotMatch(pocketQuickApprovalSource, /negativeButtonText: 'Use email code'/)
assert.match(pocketQuickApprovalSource, /Fingerprint approval was cancelled\. Nothing was sent\./)
...
assert.match(pocketQuickApprovalSource, /await savePocketEvmQuickSession\(email, session\)/)
...
assert.match(circlePocketAppBootSource, /PocketWalletUnlockScreen/)
