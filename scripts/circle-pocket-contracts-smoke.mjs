...
assert.match(pocketRouteShellSource, /style=\{\{ top: headerHeight, scrollPaddingTop: 16/)
assert.match(pocketRouteShellSource, /paddingTop: headerHeight > 0/)
assert.match(pocketRouteShellSource, /--pocket-status-bar-inset/)
