...
assert.match(pocketMoveBankPageSource, /direct\.status === 'processing' && Boolean\(direct\.result\?\.txHash\)/)
...
assert.match(unifiedReceiptSource, /h-\[calc\(100dvh-56px\)\]/)
assert.match(unifiedReceiptSource, /surface === 'receipt' \? 'overflow-hidden'/)
...
assert.match(paymentReceiptSuccessSource, /h-\[calc\(100dvh-56px\)\]/)
