...
assert.match(pocketWalletControllerSource, /pendingEvmSessions\.current\.get\(key\)/)
assert.match(pocketWalletControllerSource, /isExpiredEmailChallenge\(reason\)/)
...
assert.match(pocketSessionSplashSource, /setState\('mark'\), 160/)
assert.match(pocketSessionSplashSource, /setState\('assembling'\), 620/)
assert.match(pocketSessionSplashSource, /setState\('holding'\), 1_300/)
assert.match(pocketSessionSplashSource, /state !== 'holding' \|\| !canLaunch/)
assert.match(pocketSessionSplashSource, /setState\('idle'\), 900/)
...
assert.match(pocketRouteShellSource, /pullDistanceRef\.current < 48/)
...
assert.match(pocketBankWithdrawControllerSource, /recovered \?\? await readPocketBankWithdrawStatus/)
...
assert.match(pocketHomePageSource, /!activityReady \? Array\.from\(\{ length: 4 \}\)/)
assert.match(pocketHomePageSource, /Recent activity/)
...
assert.match(pocketPushNotificationsSource, /if \(!POCKET_PUSH_ENABLED \|\| !Capacitor\.isNativePlatform\(\)/)
