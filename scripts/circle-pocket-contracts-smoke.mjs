...
assert.match(pocketEmailLoginSource, /<PocketAuthBrand compact \/>/)
assert.match(pocketEmailLoginSource, /border-2 bg-white text-2xl font-black text-gray-950/)
assert.match(pocketEmailLoginSource, /border-blue-600 ring-4 ring-blue-500\/15/)
