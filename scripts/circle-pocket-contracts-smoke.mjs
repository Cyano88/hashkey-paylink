...
assert.match(pocketQuickApprovalSource, /negativeButtonText: 'Use email code'/)
assert.match(pocketQuickApprovalSource, /refreshCircleEvmEmailSession/)
assert.match(pocketQuickApprovalSource, /session = await refreshCircleEvmEmailSession\(session\)/)
...
assert.match(pocketSlideActionSource, /return <SlideAction/)
...
assert.match(pocketBankWithdrawControllerSource, /The payout quote expired before any money was sent\. Your details are still here; slide again to refresh it\./)
...
assert.match(pocketSlideActionSource, /idle: 'Slide to withdraw'/)
assert.match(pocketSlideActionSource, /disabled: 'Enter withdrawal details'/)
assert.match(pocketSlideActionSource, /labels=\{\{ \.\.\.POCKET_DEFAULT_LABELS, \.\.\.labels \}\}/)
