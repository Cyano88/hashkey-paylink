...
assert.match(circlePocketAppSource, /import PocketProfilePage from '.\/pages\/PocketProfilePage'/)
...
assert.match(circlePocketAppSource, /if \(landing\) return <PocketLandingPage splashState=\{splashState\} \/>/)
