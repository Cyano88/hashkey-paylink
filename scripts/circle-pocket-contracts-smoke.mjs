...
assert.match(unifiedReceiptSource, /Open receipt PDF/)
assert.match(unifiedReceiptSource, /createPaymentReceiptPdf\(resolved\)/)
...
assert.match(unifiedReceiptSource, /paymentReceiptFileName\(resolved\)/)
assert.match(unifiedReceiptSource, /window\.open\('about:blank', '_blank'\)/)
assert.match(unifiedReceiptSource, /\/api\/x402\/receipt\?id=/)
assert.match(unifiedReceiptSource, /\/api\/receipt\?id=/)
assert.doesNotMatch(unifiedReceiptSource, /Share as image/)
assert.doesNotMatch(unifiedReceiptSource, /paymentReceiptView|Hash_PayLink|<dl|Receipt details/)
