import{dp as F,dq as T,dr as I,dt as d,dT as y,di as t,dV as k,eo as q,dQ as O,dj as n}from"./index-D3N6vbL1.js";import{h as _}from"./CopyToClipboard-DSTf_eKU-DAKnh3Jw.js";import{n as B}from"./OpenLink-DZHy38vr-BEMwOl9X.js";import{C as A}from"./QrCode-cBrqXGmp-BKUrlbAs.js";import{n as E}from"./ScreenLayout-Dmp7r6fS-BIuI9JwK.js";import{l as h}from"./farcaster-DPlSjvF5-BGmDSlMf.js";import"./browser-Bxlwbvq2.js";import"./ModalHeader-rFKqcgRs-DSFA_yib.js";import"./Screen-DXLhhfU3-CP8nSkEC.js";import"./index-Dq_xe9dz-B4wILuhb.js";let S="#8a63d2";const M=({appName:u,loading:m,success:i,errorMessage:e,connectUri:r,onBack:s,onClose:c,onOpenFarcaster:o})=>t.jsx(E,k||m?q?{title:e?e.message:"Add a signer to Farcaster",subtitle:e?e.detail:`This will allow ${u} to add casts, likes, follows, and more on your behalf.`,icon:h,iconVariant:"loading",iconLoadingStatus:{success:i,fail:!!e},primaryCta:r&&o?{label:"Open Farcaster app",onClick:o}:void 0,onBack:s,onClose:c,watermark:!0}:{title:e?e.message:"Requesting signer from Farcaster",subtitle:e?e.detail:"This should only take a moment",icon:h,iconVariant:"loading",iconLoadingStatus:{success:i,fail:!!e},onBack:s,onClose:c,watermark:!0,children:r&&k&&t.jsx(R,{children:t.jsx(B,{text:"Take me to Farcaster",url:r,color:S})})}:{title:"Add a signer to Farcaster",subtitle:`This will allow ${u} to add casts, likes, follows, and more on your behalf.`,onBack:s,onClose:c,watermark:!0,children:t.jsxs(V,{children:[t.jsx(L,{children:r?t.jsx(A,{url:r,size:275,squareLogoElement:h}):t.jsx(z,{children:t.jsx(O,{})})}),t.jsxs(N,{children:[t.jsx(P,{children:"Or copy this link and paste it into a phone browser to open the Farcaster app."}),r&&t.jsx(_,{text:r,itemName:"link",color:S})]})]})});let R=n.div`
  margin-top: 24px;
`,V=n.div`
  display: flex;
