import{i as v,b as f,c as a}from"./lit-element-DNTOwjKL.js";import{n as w,r as d,o as q}from"./class-map-BrDdi3At.js";import{k as ve,s as fe,l as ge,p as be,M as g,S as se,R as l,h as P,A as K,j as ce,i as le,C as m,m as Y,n as ye,o as S,E as ie,O as E,q as F,u as oe,v as T,x as H,T as xe,y as Ce,z as ke,B as Se}from"./core-PSnJUh2E.js";import{c as u,U as We}from"./index-Bwk_7Xbq.js";import"./index-DqAnZdBU.js";import"./index.es-7UHoElzq.js";import"./browser-VG5t546r.js";import"./async-directive-BXv23fxk.js";const p=be({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),Re={state:p,subscribe(r){return ge(p,()=>r(p))},subscribeKey(r,e){return fe(p,r,e)},showTooltip({message:r,triggerRect:e,variant:t}){p.open=!0,p.message=r,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},O=ve(Re),de={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await se.isSIWXCloseDisabled()){g.shake();return}g.close()}},$e=v`
  :host {
    display: block;
