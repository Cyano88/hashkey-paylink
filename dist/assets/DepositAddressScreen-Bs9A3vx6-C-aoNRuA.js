import{gx as se,dr as k,dt as p,dp as ie,di as r,dQ as q,dj as d,dC as ae,dX as le,gy as de}from"./index-BkFF6ujt.js";import{n as v}from"./ScreenLayout-Dmp7r6fS-N2RvlR_M.js";import{n as X}from"./styles-DVyDvTdj-DeNi2biZ.js";import{a as H,C as ce}from"./poll-CGBuN8pf-4FWbqiJK.js";import{m as ue}from"./ModalHeader-rFKqcgRs-ViBTbe-G.js";import{C as me}from"./QrCode-cBrqXGmp-BziBlX40.js";import{u as pe,a as he,s as fe,b as ge,c as ye,d as be,e as ve,f as xe,g as Ce,F as we,h as ke,o as Ee,i as _e,j as je}from"./floating-ui.react-DrP8s1ZE.js";import{m as Te}from"./CopyableText-D2t3Xzed-CI_3sUKq.js";import"./browser-Bxlwbvq2.js";import{T as F}from"./triangle-alert-BOITvqAb.js";import{c as j}from"./createLucideIcon-B0uJ2QPP.js";import{C as $}from"./check-CpMYuBPf.js";import{H as Se}from"./hourglass-CNMAO79o.js";import"./Screen-DXLhhfU3-K9zMCUdN.js";import"./index-Dq_xe9dz-Eo4mbEDB.js";import"./copy-D9fVnCX0.js";const Ne={path:"/api/v1/onramp/deposit_addresses/quote",method:"POST"},Q={path:"/api/v1/onramp/deposit_addresses/orders/:order_id",method:"GET"},Ue={path:"/api/v1/onramp/deposit_addresses/:deposit_address_id/next_order",method:"GET"},Ie={path:"/api/v1/onramp/deposit_addresses/deposit_config",method:"GET"},w=se(()=>null),_=e=>{w.getState()!==null&&w.setState(e)};async function Oe(e){let t=await e.fetchPrivyRoute(Ie,{});_({config:{status:"ready",data:{currencies:t.currencies,chains:t.chains}}})}function f(){let e=w(),{closePrivyModal:t,privy:o}=k(),n=(e==null?void 0:e.params)??null,i=(e==null?void 0:e.config)??{status:"loading"},a=p.useCallback(s=>{_({modalState:s})},[]),l=p.useCallback(async()=>{if(n){_({config:{status:"loading"}});try{await Oe(o)}catch(s){throw _({config:{status:"error",error:s instanceof Error?s:Error("Failed to load deposit config")}}),s}}},[n,o]),u=p.useCallback(()=>{if(!e)return;let{modalState:s}=e;s.step==="complete"?e.onComplete():s.step==="failed"?e.onError(Error("DEPOSIT_FAILED")):s.step==="error"?e.onError(Error(s.code)):s.step==="refunded"?e.onError(Error("DEPOSIT_REFUNDED")):e.onError(Error("USER_EXITED")),t({shouldCallAuthOnSuccess:!1})},[e,t]);return{modalState:(e==null?void 0:e.modalState)??{step:"intro"},setModalState:a,config:i,retryConfig:l,params:n,close:u}}function x(e){let{modalState:t,config:o,params:n,...i}=f();if(function(a,l){if(a.step!==l)throw Error("UNEXPECTED_STATE")}(t,e),!n||o.status!=="ready")throw Error("UNEXPECTED_STATE");return{state:t,configData:o.data,params:n,...i}}/**
