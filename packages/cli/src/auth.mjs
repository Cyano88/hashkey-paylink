...
export async function authCommand(command, options, { fetcher, sessionStore }) {
  if (command === 'auth login') {
    ...
    const allowed = ['project:read', 'checkout:read', 'checkout:create', 'agreement:read', 'agreement:create', 'xstocks-agreement:read', 'wallet:connect', 'xstocks-agreement:create', 'keys:manage']
