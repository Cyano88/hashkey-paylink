...
Commands:
  ...
  hosting plan --provider <render|railway> [--product checkout|agreement|agreement-funding|wallet-connection|arc-wallet|stock-balance|xstocks-agreement|wallet-swap] --service <id> --key-id <id> --backend
