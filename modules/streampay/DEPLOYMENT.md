...
|---|---|---|
| `STREAM_FACTORY_ADDRESS` | `0xBAecf54084A0cB65b77a88cbDEf2b663Be71c61b` | Server-side factory address (Arc Testnet) |
| `VITE_STREAM_FACTORY_ADDRESS` | `0xBAecf54084A0cB65b77a88cbDEf2b663Be71c61b` | Browser-side factory address (must match above) |
