...
/**
 * @title CheckpointVault
 * @notice Escrow for progress-based creator reading. The reader prepays the
 *         full cap into this vault. HashpayStream's relayer releases cumulative
 *         checkpoints as the reader reaches durable progress marks, and the
 *         reader can refund any unreleased balance.
 */
