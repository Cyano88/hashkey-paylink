...
export default function PocketVerifiedNameGate() {
  ...
  return <button type="button" onClick={() => navigate(POCKET_BASE_PATH + POCKET_ROUTES.verifyName)} className="flex w-full items-center gap-3 rounded-[22px] border border-gray-200 bg-white p-4 text-left shadow-sm transition hover:border-gray-300 dark:border-[#262626] dark:bg-[#121212] dark:shadow-none dark:hover:border-white/20">
