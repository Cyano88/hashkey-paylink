export type PocketMigrationNetwork = 'base' | 'arbitrum' | 'arc' | 'ethereum' | 'polygon'
...
export type PocketMigrationFee = {
  id:string;revision:string;network:PocketMigrationNetwork;amount:string;asset:'ETH'|'USDC'|'POL';expiresAt:number
