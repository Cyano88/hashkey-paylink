...
export const POCKET_API = {
  session: pocketApiUrl('/api/pocket/session'),
  profile: pocketApiUrl('/api/pocket/profile'),
  wallets: pocketApiUrl('/api/pocket/wallets'),
  ...
  bankSend: pocketApiUrl('/api/pocket/bank-send'),
  bankWithdraw: pocketApiUrl('/api/pocket/bank-withdraw'),
  evmTransferStatus: pocketApiUrl('/api/pocket/transfers/evm-status'),
  pos: pocketApiUrl('/api/pocket/pos'),
  billsQuote: pocketApiUrl('/api/pocket/bills/quote'),
  billsCatalog: pocketApiUrl('/api/pocket/bills/catalog'),
  billsVerify: pocketApiUrl('/api/pocket/bills/verify'),
  billsPay: pocketApiUrl('/api/pocket/bills/pay'),
  billsRefund: pocketApiUrl('/api/pocket/bills/refund'),
  activity: pocketApiUrl('/api/pocket/activity'),
  bridge: pocketApiUrl('/api/pocket/bridge'),
  solanaCctpPrepare: pocketApiUrl('/api/pocket/bridge/solana/prepare'),
  solanaCctpSubmit: pocketApiUrl('/api/pocket/bridge/solana/submit'),
  solanaRpc: pocketApiUrl('/api/pocket/solana-rpc'),
  x402: pocketApiUrl('/api/pocket/x402'),
  x402Connect: pocketApiUrl('/api/pocket/x402/connect'),
  x402Activate: pocketApiUrl('/api/pocket/x402/activate'),
  marketplace: pocketApiUrl('/api/pocket/marketplace'),
  agentAsk: pocketApiUrl('/api/pocket/agent/ask'),
  agentConfirm: pocketApiUrl('/api/pocket/agent/confirm'),
} as const
