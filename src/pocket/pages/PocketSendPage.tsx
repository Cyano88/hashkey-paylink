...
export default function PocketSendPage() {
  ...
  const resultOpen = !resultDismissed && (send.status === 'submitted' || send.status === 'successful' || requestConfirmed || requestAccepted || Boolean(paymentTxHash) || Boolean(attemptedAt && send.error))
