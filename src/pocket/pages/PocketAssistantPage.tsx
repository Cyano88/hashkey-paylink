...
export default function PocketAssistantPage() {
  ...
  return (
    <div className='fixed inset-0 z-[55] h-[100dvh] overflow-hidden bg-white text-gray-950 dark:bg-black dark:text-white'>
      <main className='mx-auto flex h-[100dvh] w-full max-w-[480px] flex-col overflow-hidden' style={{ paddingTop: 'max(var(--pocket-safe-top), 0.5rem)', paddingBottom: 'var(--pocket-safe-bottom)' }}>
