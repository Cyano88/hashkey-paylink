...
export default function PocketMoveLanding() {
  return (
    <div className="flex min-h-[360px] flex-col items-center justify-center px-5 text-center">
      <span className="flex h-12 w-12 items-center justify-center rounded-2xl border border-gray-200 bg-white text-gray-600 shadow-sm dark:border-[#262626] dark:bg-[#171717] dark:text-gray-300">
