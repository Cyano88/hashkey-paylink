  ...
  return (
    <div className={cn(
      ...
      embedded
        ...
        : 'rounded-xl border border-gray-100 bg-gray-50/70 p-2.5 dark:border-[#262626] dark:bg-[#171717]',
    )}>
      <div>
          ...
          <label className="block">
            ...
            {institutionsBusy && !institutions.length ? <PocketLoadingField label="Loading banks" /> : institutions.length ? (
              ...
              <input
                ...
                className="mt-1 w-full rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm font-medium text-gray-950 outline-none placeholder:text-gray-300 focus:border-gray-400 dark:border-[#262626] dark:bg-[#171717] dark:text-white dark:placeholder:text-gray-600"
              />
            )}
          </label>
          <label className="block">
            ...
            <div className="relative mt-1">
              <input
                ...
                className="w-full rounded-lg border border-gray-200 bg-white px-3 py-2 pr-10 text-sm font-medium tabular-nums text-gray-950 outline-none placeholder:text-gray-300 focus:border-gray-400 dark:border-[#262626] dark:bg-[#171717] dark:text-white dark:placeholder:text-gray-600"
              />
