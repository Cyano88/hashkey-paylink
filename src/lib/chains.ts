...
export const CHAIN_META = {
  ...
  arc: {
    ...
    // Glow: Clean Teal #00FFA3
    glowStyle: '0 0 52px -8px rgba(0,255,163,0.30), 0 0 0 1px rgba(0,255,163,0.14)',
    accentColor: '#00FFA3',
    badgeBg: 'bg-teal-50',
    badgeText: 'text-teal-700',
    badgeBorder: 'border-teal-200',
    toggleActive: 'bg-[#00FFA3] text-gray-900 shadow-sm',
    headerBg: 'from-teal-50 to-emerald-50',
    dotColor: 'bg-[#00FFA3]',
