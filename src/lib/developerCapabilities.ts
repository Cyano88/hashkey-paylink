...
export const DEVELOPER_CAPABILITIES_VERSION = 1
...
export const DEVELOPER_PRODUCTS = [
  ...
  { id: 'arc_agreements', name: 'Agreements', live: { networks: ['arc'], status: 'draft_only' }, sandbox: { networks: ['arc_testnet'], status: 'not_enabled', reason: 'Isolated draft storage and a reviewed testnet deployment are required before lifecycle testing.' } },
