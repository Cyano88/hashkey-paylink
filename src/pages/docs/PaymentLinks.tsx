  ...
  return (
    <DocPage>
      ...
      <Section title="Payment amount">
        <p>Fixed hosted checkout sends the exact recipient amount selected by the payment request. Circle-wallet EVM payments use Circle Gas Station on Base, Arbitrum, and Arc Mainnet, so only the standard platform fee is added separately. Legacy external-wallet relays may retain a separately disclosed gas-recovery amount.</p>
